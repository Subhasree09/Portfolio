    ...
    <>
      ...
      >
        <div className="WRAPPER mt-12 flex justify-between max-sm:flex-col gap-5">
          <div className="INTRO text-6xl leading-[80px] font-semibold max-sm:text-4xl max-sm:leading-[70px] max-sm:font-semibold">
            ...
            <p className="ABOUT h-[100px] text-xl max-sm:text-base bg-clip-text text-transparent bg-gradient-to-r from-[#00040f] to-slate-500 dark:from-slate-500 dark:to-slate-200 max-w-[470px] mt-5 pl-1">
