...
const Navbar = () => {
  ...
  return (
    <>
      <section className="NAVBAR mx-20 mt-5 font-['Poppins'] max-sm:p-2 max-sm:mx-5 max-sm:max-h-[48px]">
        <div className="NAVBAR flex  justify-between max-sm:justify-between capitalize">
          <div className="LOGO">
            <a
              href="#"
              className="text-3xl bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent  max-sm:text-2xl"
            >
              {"<Subhasree/>"}
            </a>
          </div>
          <div className="NAVLINKS text-[20px] translate-x-[80px] w-fit max-sm:hidden flex flex-wrap justify-center gap-4 text-[#00040f] dark:text-[#e1e1e1] ">
